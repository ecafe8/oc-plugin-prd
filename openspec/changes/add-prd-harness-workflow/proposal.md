...
- `review-gated-planning`: Enforce structured PRD self-checks and approval gates before splitting features, planning work, or starting implementation.
...
- Defines new schemas for trackers, review results, manifests, and workflow state.
